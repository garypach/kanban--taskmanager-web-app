...
function Header() {
  ...
  return (
    <div className="bg-white dark:bg-dark-gray w-full flex justify-center items-center min-h-[64px] relative z-50 md:min-h-[81px] lg:min-h-[96px]">
        <nav className="text-[black] dark:text-[white] w-full flex justify-between items-center px-[16px] md:px-[26px] lg:px-[34px]">
            ...
            <div className='hidden w-[1px] ml-[82.47px] mr-[24px] md:block md:min-h-[81px] lg:min-h-[96px] lg:ml-[113.47px]  dark:bg-dark-lines bg-light-lines'>
