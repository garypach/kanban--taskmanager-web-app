...
function DeleteBoardMenu() {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`absolute top-[80px] mx-auto left-0 right-0 transition-all bg-[white] dark:bg-dark-gray min-w-[343px] max-w-[343px] md:max-w-[480px] z-30 p-[24px] rounded-[20px] border-light-lines dark:border-dark-lines`}
      >
